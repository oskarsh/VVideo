...
export function AboutModal({
  ...
  return (
    <Modal open={open} onClose={onClose} contentClassName="bg-zinc-900 border border-white/15 rounded-xl shadow-2xl max-w-md w-full max-h-[85vh] overflow-hidden flex flex-col">
